...
<project xsi:schemaLocation="http://maven.apache.org/POM/4.0.0 http://maven.apache.org/xsd/maven-4.0.0.xsd" xmlns="http://maven.apache.org/POM/4.0.0"
  ...
  <scm>
    <url>https://github.com.cnpmjs.org/tensorflow/tensorflow.git</url>
    <connection>git@github.com:tensorflow/tensorflow.git</connection>
    <developerConnection>scm:git:https://github.com.cnpmjs.org/tensorflow/tensorflow.git</developerConnection>
  </scm>
</project>
  )EOF");
