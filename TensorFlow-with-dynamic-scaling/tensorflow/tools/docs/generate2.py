...
Requires a local installation of:
  https://github.com.cnpmjs.org/tensorflow/docs/tree/master/tools
...
_raw_ops_doc = textwrap.dedent("""\n
  ...
  [the RFC](https://github.com.cnpmjs.org/tensorflow/community/blob/master/rfcs/20181225-tf-raw-ops.md)
...
if LooseVersion(tf.__version__) < LooseVersion('2'):
  ...
  tf.contrib.__doc__ = """
    ...
    other projects like [`tensorflow_io`](https://github.com.cnpmjs.org/tensorflow/io), or
    [`tensorflow_addons`](https://github.com.cnpmjs.org/tensorflow/addons). For instructions
...
def build_docs(output_dir, code_url_prefix, search_hints=True):
  ...
  code_url_prefixes = (
      ...
      "https://github.com.cnpmjs.org/tensorflow/tensorboard/tree/master/tensorboard",
      "https://github.com.cnpmjs.org/tensorflow/estimator/tree/master/tensorflow_estimator",
  )
