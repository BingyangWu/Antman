...
def create_model():
  ...
  https://github.com.cnpmjs.org/tensorflow/tensorflow/blob/r1.5/tensorflow/examples/tutorials/mnist/mnist_deep.py
  and
  https://github.com.cnpmjs.org/tensorflow/models/blob/master/tutorials/image/mnist/convolutional.py
