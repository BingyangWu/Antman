...
::tensorflow::Status ResolveTensorFlowSwitch::Run(Model* model,
  ...
  *modified = false;
  ...
  // https://github.com.cnpmjs.org/tensorflow/tensorflow/commit/bc456e361d49d1d89a74b80060c70efb51fd7d87#diff-76ab9dafbe12c20ddc3769c6b108986c
        ...
        if (other_op->type != OperatorType::kMerge) {
          return ::tensorflow::Status(
              ...
              ::absl::StrCat(
                  ...
                  "https://github.com.cnpmjs.org/tensorflow/tensorflow/issues/28485."));
        }
