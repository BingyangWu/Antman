...
## Profile your model
Once you have selected a candidate model that is right for your task, it is a good practice to profile and benchmark your model. TensorFlow Lite [benchmarking tool](https://github.com.cnpmjs.org/tensorflow/tensorflow/tree/master/tensorflow/lite/tools/benchmark) has a built-in profiler that shows per operator profiling statistics. This can help in understanding performance bottlenecks and which operators dominate the computation time.
...
[quantized training](https://github.com.cnpmjs.org/tensorflow/tensorflow/blob/master/tensorflow/contrib/quantize/README.md){:.external}.
...
[threads](https://github.com.cnpmjs.org/tensorflow/tensorflow/blob/master/tensorflow/lite/interpreter.h#L346).
...
[inputs](https://github.com.cnpmjs.org/tensorflow/tensorflow/blob/master/tensorflow/lite/java/src/main/java/org/tensorflow/lite/Interpreter.java#L175).
...
[GitHub](https://github.com.cnpmjs.org/tensorflow/tensorflow/issues) with details of the
issue.
