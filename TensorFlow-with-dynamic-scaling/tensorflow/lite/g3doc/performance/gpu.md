...
```
git clone https://github.com.cnpmjs.org/tensorflow/tensorflow
```
...
* [PoseNet for pose estimation](https://github.com.cnpmjs.org/tensorflow/tfjs-models/tree/master/posenet) [[download]](https://storage.googleapis.com/download.tensorflow.org/models/tflite/gpu/multi_person_mobilenet_v1_075_float.tflite)
