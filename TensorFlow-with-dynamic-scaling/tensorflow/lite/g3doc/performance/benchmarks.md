...
[Android TFLite benchmark binary](https://github.com.cnpmjs.org/tensorflow/tensorflow/tree/master/tensorflow/lite/tools/benchmark)
and the [iOS benchmark app](https://github.com.cnpmjs.org/tensorflow/tensorflow/tree/master/tensorflow/lite/tools/benchmark/ios).

# Android performance benchmarks

For Android benchmarks, the CPU affinity is set to use big cores on the device to
reduce variance (see [details](https://github.com.cnpmjs.org/tensorflow/tensorflow/tree/master/tensorflow/lite/tools/benchmark#reducing-variance-between-runs-on-android)).
...
using [these instructions](https://github.com.cnpmjs.org/tensorflow/tensorflow/tree/master/tensorflow/lite/tools/benchmark#on-android)
...
app](https://github.com.cnpmjs.org/tensorflow/tensorflow/tree/master/tensorflow/lite/tools/benchmark/ios)
