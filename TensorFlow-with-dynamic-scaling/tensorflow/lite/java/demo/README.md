...
1. Follow the [Bazel steps for the TF Demo App](https://github.com.cnpmjs.org/tensorflow/tensorflow/tree/master/tensorflow/examples/android#bazel):

  1. [Install Bazel and Android Prerequisites](https://github.com.cnpmjs.org/tensorflow/tensorflow/tree/master/tensorflow/examples/android#install-bazel-and-android-prerequisites).
  ...
  2. [Edit your `WORKSPACE`](https://github.com.cnpmjs.org/tensorflow/tensorflow/tree/master/tensorflow/examples/android#edit-workspace)
...
3. Install the demo on a
   [debug-enabled device](https://github.com.cnpmjs.org/tensorflow/tensorflow/tree/master/tensorflow/examples/android#install):
