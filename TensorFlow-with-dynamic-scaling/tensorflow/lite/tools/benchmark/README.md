...
[iOS benchmark app](https://github.com.cnpmjs.org/tensorflow/tensorflow/tree/master/tensorflow/lite/tools/benchmark/ios).
...
located
[here](https://github.com.cnpmjs.org/tensorflow/tensorflow/tree/master/tensorflow/lite/tools/benchmark/android).
...
*   `use_gpu`: `bool` (default=false) \
    Whether to use the [GPU accelerator delegate](https://github.com.cnpmjs.org/tensorflow/tensorflow/tree/master/tensorflow/lite/delegates/gpu).
