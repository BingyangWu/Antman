...
With the help of
[OpHint](https://github.com.cnpmjs.org/tensorflow/tensorflow/blob/master/tensorflow/lite/python/op_hint.py)
...
[Netron](https://github.com.cnpmjs.org/lutzroeder/netron) to visualize the graph.
