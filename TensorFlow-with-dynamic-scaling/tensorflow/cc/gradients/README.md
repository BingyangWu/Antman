...
[python](https://github.com.cnpmjs.org/tensorflow/tensorflow/tree/master/tensorflow/python/ops)
...
4.  Tests should be included in `foo_grad_test.cc`. Please see
    [`array_grad_test.cc`](https://github.com.cnpmjs.org/tensorflow/tensorflow/blob/master/tensorflow/cc/gradients/array_grad_test.cc)
    ...
    checker](https://github.com.cnpmjs.org/tensorflow/tensorflow/blob/master/tensorflow/cc/framework/gradient_checker.cc)
