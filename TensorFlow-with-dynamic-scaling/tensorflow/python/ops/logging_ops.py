...
# See https://github.com.cnpmjs.org/tensorflow/tensorflow/issues/18053
...
def histogram_summary(tag, values, collections=None, name=None):
  ...
  migrate, look
  ['here'](https://github.com.cnpmjs.org/tensorflow/tensorflow/blob/master/tensorflow/contrib/deprecated/__init__.py)
