...
class Server(object):
  ...
  def __del__(self):
    try:
      ...
      # See:
      # https://github.com.cnpmjs.org/tensorflow/tensorflow/blob/0495317a6e9dd4cac577b9d5cf9525e62b571018/tensorflow/core/distributed_runtime/rpc/grpc_server_lib.h#L73
