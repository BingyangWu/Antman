...
* A [gRPC](https://grpc.io/)-based remote debugging protocol, which allows us to
  ...
  [TensorBoard Debugger Plugin](https://github.com.cnpmjs.org/tensorflow/tensorboard/blob/master/tensorboard/plugins/debugger/README.md).
...
* For information on the web GUI of TFDBG (TensorBoard Debugger Plugin), see
  [this README](https://github.com.cnpmjs.org/tensorflow/tensorboard/blob/master/tensorboard/plugins/debugger/README.md).
