...
class RNNV2Test(keras_parameterized.TestCase):
  ...
  def test_reset_dropout_mask_between_batch(self, layer):
    # See https://github.com.cnpmjs.org/tensorflow/tensorflow/issues/29187 for more details
    batch_size = 8
    timestep = 12
    embedding_dim = 10
    units = 5
  ...
  def test_recurrent_dropout_with_stateful_RNN(self, layer):
    # See https://github.com.cnpmjs.org/tensorflow/tensorflow/issues/27829 for details.
