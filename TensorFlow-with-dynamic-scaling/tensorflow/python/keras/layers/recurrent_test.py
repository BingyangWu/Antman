...
class RNNTest(keras_parameterized.TestCase):
  ...
  def test_full_input_spec(self):
    # See https://github.com.cnpmjs.org/tensorflow/tensorflow/issues/25985
  ...
  def test_reset_states(self):
    # See https://github.com.cnpmjs.org/tensorflow/tensorflow/issues/25852
  ...
  def test_stateful_rnn_with_stacking(self, cell):
    # See https://github.com.cnpmjs.org/tensorflow/tensorflow/issues/28614.
    batch = 12
    timesteps = 10
    input_dim = 8
    output_dim = 64
  ...
  def test_state_spec_with_stack_cell(self, cell):
    # See https://github.com.cnpmjs.org/tensorflow/tensorflow/issues/27817 for more detail.
    batch = 12
    timesteps = 10
    input_dim = 8
    output_dim = 8
