...
- [Known issues](https://github.com.cnpmjs.org/tensorflow/tensorflow/issues?q=is%3Aissue%20is%3Aopen%20label%3Acomp%3Aeager)
- Feedback is welcome, please consider
  [filing an issue](https://github.com.cnpmjs.org/tensorflow/tensorflow/issues/new) to provide it.
...
- [User Guide](https://www.tensorflow.org/guide/eager) ([source](https://github.com.cnpmjs.org/tensorflow/docs/blob/master/site/en/tutorials/eager/index.md))
- Notebook: [Basic Usage](https://github.com.cnpmjs.org/tensorflow/docs/blob/master/site/en/tutorials/eager/eager_basics.ipynb)
- Notebook: [Automatic differentiation and gradient tape](https://github.com.cnpmjs.org/tensorflow/docs/blob/master/site/en/tutorials/eager/automatic_differentiation.ipynb)
